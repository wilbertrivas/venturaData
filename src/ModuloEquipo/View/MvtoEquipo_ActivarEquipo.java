...
public final class MvtoEquipo_ActivarEquipo extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    public MvtoEquipo_ActivarEquipo(Usuario user, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_activarEquipo = new javax.swing.JButton();
        ...
        btn_activarMvtoCarbon = new javax.swing.JButton();
        ...
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(titulo38, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 530, 100, 30));

        btn_activarEquipo.setBackground(new java.awt.Color(255, 255, 255));
        btn_activarEquipo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_activarEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/save.png"))); // NOI18N
        btn_activarEquipo.setText("ACTIVAR");
        btn_activarEquipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_activarEquipoActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(btn_activarEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 670, 240, 40));
        ...
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 530, 830, 120));
        ...
        btn_activarMvtoCarbon.setBackground(new java.awt.Color(255, 255, 255));
        btn_activarMvtoCarbon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/save.png"))); // NOI18N
        btn_activarMvtoCarbon.setText("ACTIVAR");
        btn_activarMvtoCarbon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_activarMvtoCarbonActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(btn_activarMvtoCarbon, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 740, 170, 40));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 610, 810, 120));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(titulo40, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 610, 100, 20));
        ...
        InternalFrameSelectorCampos.getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 500, 230, -1));
        ...
        InternalFrameSelectorCampos.getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 500, 230, -1));
        ...
        add(InternalFrameSelectorCampos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1490, 690));

        titulo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        titulo.setText("ACTIVAR MOVIMIENTO DE EQUIPOS");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 1320, 470));
        ...
        add(paginationPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 560, 1290, 70));

        add(pageJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 10, 70, 40));
    ...
    private void btn_activarMvtoCarbonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activarMvtoCarbonActionPerformed
        if(observacion_autorizacionMvtoCarbon.getText().equals("")){
            JOptionPane.showMessageDialog(null, "La observación de la activación no puede estar vacia", "Advertencia",JOptionPane.INFORMATION_MESSAGE);
        }else{
            try {
                if(mvto_listEquipo != null){ 
                    int retorno= new ControlDB_MvtoEquipo(tipoConexion).activarEquipoCarbon(mvto_listEquipo, user,observacion_autorizacionMvtoCarbon.getText());
                    if(retorno==1){
                        JOptionPane.showMessageDialog(null, "Se registro la activación del equipo", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
                        observacion_autorizacionMvtoCarbon.setText("");
                        generarListadoMvtoCarbon();
                        InternaFrame_VisualizarMvtoCarbon.show(false);    
                    }else{
                        JOptionPane.showMessageDialog(null, "No se puedo registrar la activación del equipo, valide datos", "Error al registrar",JOptionPane.ERROR_MESSAGE);
                    }
                }
    ...
    }//GEN-LAST:event_btn_activarMvtoCarbonActionPerformed

    private void btn_activarEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_activarEquipoActionPerformed
        if(observacion_autorizacionMvtoEquipo.getText().equals("")){
            JOptionPane.showMessageDialog(null, "La observación de la activación no puede estar vacia", "Advertencia",JOptionPane.INFORMATION_MESSAGE);
        }else{
            try {
                if(equipo != null){ 
                    int retorno= new ControlDB_MvtoEquipo(tipoConexion).activarEquipo(equipo, user,observacion_autorizacionMvtoEquipo.getText());
                    if(retorno==1){
                        JOptionPane.showMessageDialog(null, "Se registro la activación del equipo", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_btn_activarEquipoActionPerformed
    ...
    private javax.swing.JButton btn_activarEquipo;
    private javax.swing.JButton btn_activarMvtoCarbon;
    ...
    public void tabla_Listar(String data1, String data2) throws SQLException{
        tabla.setModel(crearModeloDeTabla());
        listado=new ControlDB_MvtoEquipo(tipoConexion).buscar_MvtoEquipoInactivos(data1, data2);
        if(listado != null){
            proveedorDeDatos = crearProveedorDeDatos(listado); 
            paginadorDeTabla = new PaginadorDeTabla(tabla, proveedorDeDatos, new int[]{5, 10, 20, 50, 75, 100}, 10);
            paginadorDeTabla.crearListadoDeFilasPermitidas(this.paginationPanel);
