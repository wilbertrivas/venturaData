...
public final class MvtoEquipo_InactivarEquipo extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ArrayList<MvtoEquipo> listado=null;
    private Usuario user;
    //MvtoEquipo equipo= null;
    ...
    private MvtoEquipo equipo= null;
    MvtoCarbon_ListadoEquipos mvto_listEquipo = null;
    public MvtoEquipo_InactivarEquipo(Usuario user, String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            if(listadoCausaInactividad != null){
                for(CausaInactividad objeto :listadoCausaInactividad ){
                    motivoInactivacionMvtoEquipo.addItem(objeto.getDescripcion());
                    motivoInactivacionMvtoCarbon.addItem(objeto.getDescripcion());
                }
            }
    ...
    private void initComponents() {
        ...
        btn_inactivarEquipo = new javax.swing.JButton();
        jScrollPane4 = new javax.swing.JScrollPane();
        observacion_autorizacionMvtoEquipo = new javax.swing.JTextArea();
        motivoInactivacionMvtoEquipo = new javax.swing.JComboBox<>();
        ...
        btn_inactivacioMvtoCarbon = new javax.swing.JButton();
        jScrollPane5 = new javax.swing.JScrollPane();
        observacion_autorizacionMvtoCarbon = new javax.swing.JTextArea();
        titulo40 = new javax.swing.JLabel();
        motivoInactivacionMvtoCarbon = new javax.swing.JComboBox<>();
        ...
        btn_inactivarEquipo.setBackground(new java.awt.Color(255, 255, 255));
        btn_inactivarEquipo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_inactivarEquipo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/save.png"))); // NOI18N
        btn_inactivarEquipo.setText("INACTIVAR");
        btn_inactivarEquipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_inactivarEquipoActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(btn_inactivarEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 700, 190, 40));
        ...
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 570, 910, 120));

        motivoInactivacionMvtoEquipo.setToolTipText("");
        motivoInactivacionMvtoEquipo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                motivoInactivacionMvtoEquipoItemStateChanged(evt);
            }
        });
        motivoInactivacionMvtoEquipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                motivoInactivacionMvtoEquipoActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(motivoInactivacionMvtoEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 530, 360, 30));

        titulo41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo41.setForeground(new java.awt.Color(51, 51, 51));
        titulo41.setText("CAUSA DE INACTIVIDAD:");
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(titulo41, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, 190, 20));
        ...
        jLabel92.setText("INFORMACIÓN DEL CLIENTE");
        jLabel92.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jLabel92, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 360, 570, 20));

        jLabel69.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel69.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jLabel69, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 570, 480));

        jLabel107.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel107.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jLabel107, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 40, 570, 480));

        jLabel58.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel58.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternaFrame_VisualizarMvtoEquipo.getContentPane().add(jLabel58, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 1140, 230));

        add(InternaFrame_VisualizarMvtoEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 780));
        ...
        InternaFrame_VisualizarMvtoCarbon.setVerifyInputWhenFocusTarget(false);
        ...
        btn_inactivacioMvtoCarbon.setBackground(new java.awt.Color(255, 255, 255));
        btn_inactivacioMvtoCarbon.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btn_inactivacioMvtoCarbon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/save.png"))); // NOI18N
        btn_inactivacioMvtoCarbon.setText("INACTIVAR");
        btn_inactivacioMvtoCarbon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_inactivacioMvtoCarbonActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(btn_inactivacioMvtoCarbon, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 700, 170, 30));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 650, 600, 40));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(titulo40, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 660, 100, 20));

        motivoInactivacionMvtoCarbon.setToolTipText("");
        motivoInactivacionMvtoCarbon.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                motivoInactivacionMvtoCarbonItemStateChanged(evt);
            }
        });
        motivoInactivacionMvtoCarbon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                motivoInactivacionMvtoCarbonActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(motivoInactivacionMvtoCarbon, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 610, 360, 30));

        titulo42.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo42.setForeground(new java.awt.Color(51, 51, 51));
        titulo42.setText("CAUSA DE INACTIVIDAD:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(titulo42, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 610, 190, 20));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 600, 1110, 140));

        add(InternaFrame_VisualizarMvtoCarbon, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 780));
        ...
        add(InternalFrameSelectorCampos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1360, 780));

        titulo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        titulo.setText("INACTIVAR MOVIMIENTO DE EQUIPOS");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 1300, 550));
        ...
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 1290, 10));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 40, 40, 40));
        ...
        add(paginationPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 640, 1290, 70));

        add(pageJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 10, 70, 40));
        ...
        try{
            ...
            if(fila1==-1){
                ...
                if(equipo.getDesdeCarbon().equalsIgnoreCase("SI")){
                    ...
                    mvtEquipo_Equipo_pertenencia.setText(mvto_listEquipo.getAsignacionEquipo().getPertenencia().getDescripcion());
    ...
    private void btn_inactivacioMvtoCarbonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inactivacioMvtoCarbonActionPerformed
        if(observacion_autorizacionMvtoCarbon.getText().equals("")){
            JOptionPane.showMessageDialog(null, "La observación de la inactivación no puede estar vacia", "Advertencia",JOptionPane.INFORMATION_MESSAGE);
        }else{
            try {
                if(mvto_listEquipo != null){ 
                    if(listadoCausaInactividad != null){
                        mvto_listEquipo.getMvtoEquipo().setCausaInactividad(listadoCausaInactividad.get(motivoInactivacionMvtoCarbon.getSelectedIndex()));  
                    }
                    int retorno= new ControlDB_MvtoEquipo(tipoConexion).inactivarEquipo(mvto_listEquipo.getMvtoEquipo(), user,observacion_autorizacionMvtoCarbon.getText());
                    if(retorno==1){
                        JOptionPane.showMessageDialog(null, "Se registro la inactivación del equipo", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
                        observacion_autorizacionMvtoCarbon.setText("");
                        generarListadoMvtoCarbon();
                        InternaFrame_VisualizarMvtoCarbon.show(false);    
                    }else{
                        JOptionPane.showMessageDialog(null, "No se puedo registrar la inactivación del equipo, valide datos", "Error al registrar",JOptionPane.ERROR_MESSAGE);
                    }
                }
    ...
    }//GEN-LAST:event_btn_inactivacioMvtoCarbonActionPerformed

    private void btn_inactivarEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_inactivarEquipoActionPerformed
        if(observacion_autorizacionMvtoEquipo.getText().equals("")){
            ...
            try {
                if(equipo != null){ 
                    if(listadoCausaInactividad != null){
                        equipo.setCausaInactividad(listadoCausaInactividad.get(motivoInactivacionMvtoEquipo.getSelectedIndex()));    
                    }
                    int retorno= new ControlDB_MvtoEquipo(tipoConexion).inactivarEquipo(equipo, user,observacion_autorizacionMvtoEquipo.getText());
                    if(retorno==1){
                        JOptionPane.showMessageDialog(null, "Se registro la inactivación del equipo", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
    ...
    }//GEN-LAST:event_btn_inactivarEquipoActionPerformed
    ...
    private void motivoInactivacionMvtoEquipoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_motivoInactivacionMvtoEquipoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_motivoInactivacionMvtoEquipoItemStateChanged

    private void motivoInactivacionMvtoEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_motivoInactivacionMvtoEquipoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_motivoInactivacionMvtoEquipoActionPerformed

    private void motivoInactivacionMvtoCarbonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_motivoInactivacionMvtoCarbonItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_motivoInactivacionMvtoCarbonItemStateChanged

    private void motivoInactivacionMvtoCarbonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_motivoInactivacionMvtoCarbonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_motivoInactivacionMvtoCarbonActionPerformed
    ...
    private javax.swing.JButton btn_inactivacioMvtoCarbon;
    private javax.swing.JButton btn_inactivarEquipo;
    ...
    private javax.swing.JComboBox<String> motivoInactivacionMvtoCarbon;
    private javax.swing.JComboBox<String> motivoInactivacionMvtoEquipo;
    ...
    public void tabla_Listar(String data1, String data2) throws SQLException{
        tabla.setModel(crearModeloDeTabla());
        //listado=new ControlDB_MvtoEquipo(tipoConexion).buscar_MvtoEquipoActivos(data1, data2);
        listado=new ControlDB_MvtoEquipo(tipoConexion).buscar_MvtoEquipoConMvtoCarbonActivos(data1, data2);
        if(listado != null){
            proveedorDeDatos = crearProveedorDeDatos(listado); 
            paginadorDeTabla = new PaginadorDeTabla(tabla, proveedorDeDatos, new int[]{5, 10, 20, 50, 75, 100}, 10);
            paginadorDeTabla.crearListadoDeFilasPermitidas(this.paginationPanel);
        ...
        try{
            ...
            if(contador==2){//Se validaron las dos fechas y contienen formato correcto
                ...
                try {
                    ...
                    Logger.getLogger(MvtoEquipo_ActivarEquipo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }catch(Exception e){
