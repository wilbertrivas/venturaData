...
public class AsignacionEquipo_Consultar extends javax.swing.JPanel {
    ...
    public AsignacionEquipo_Consultar(Usuario us, String tipoConexion) throws SQLException {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(checkFechaSolicitud, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 30, 140, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(selectCentroOperacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 320, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(checkCentroOperacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 100, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(fechaInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 30, 170, 30));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 51, 51));
        jLabel7.setText("Hora");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 30, -1, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(horaInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 30, 50, 30));

        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel25.setForeground(new java.awt.Color(51, 51, 51));
        jLabel25.setText(":");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 30, 20, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(minutoInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 30, 50, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(horarioTiempoInicioSolicitudEquiposRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 30, 40, 30));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(51, 51, 51));
        jLabel8.setText("Inicio:");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, 60, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(fechaFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 70, 170, 30));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(51, 51, 51));
        jLabel12.setText("Hora");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 70, -1, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(horaFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 70, 50, 30));

        jLabel24.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel24.setText(":");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 70, 20, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(minutoFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 70, 50, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(horarioTiempoIFinalSolicitudEquiposRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 70, 50, 30));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 51, 51));
        jLabel9.setText("Fin:");
        InternalFrame_SolicitudesEquipos.getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 70, 40, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(checkUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 140, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(selectUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 320, 30));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 170, -1));
        ...
        InternalFrame_SolicitudesEquipos.getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 1250, 490));

        add(InternalFrame_SolicitudesEquipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1320, 770));
        ...
        titulo35.setText("CONSULTAR PROGRAMACIONES DE EQUIPOS");
        ...
        add(titulo41, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 490, 220, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 1260, 300));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 150, -1, -1));
        ...
        add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 1260, 250));
        ...
        confirmacion.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        confirmacion.setForeground(new java.awt.Color(102, 102, 102));
        confirmacion.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(confirmacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 210, 20));

        titulo64.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo64.setForeground(new java.awt.Color(51, 51, 51));
        titulo64.setText("Estado Solicitud:");
        add(titulo64, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 130, 20));

        titulo65.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo65.setForeground(new java.awt.Color(51, 51, 51));
        titulo65.setText("Confirmacion:");
        add(titulo65, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 130, 20));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(AsignacionEquipo_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
                ...
                if(fila1==-1){
                  ...
                  //Procedemos a cargar la nueva solicitud de Equipo    
                    ...
                    try{
                        ...
                        confirmacion.setText(solicitudEquipo.getConfirmacionSolicitudEquipo().getDescripcion());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(sql.equals("")){
            sql +=" ORDER BY [se_fecha_registro] DESC -- WHERE ([ese_cdgo] = 3 OR [ese_cdgo] = 4) AND [se_confirmacion_solicitud_equipo_cdgo] IS NULL  \n";
        }else{
            sql +=" ORDER BY [se_fecha_registro] DESC --AND ([ese_cdgo] = 3 OR [ese_cdgo] = 4) AND [se_confirmacion_solicitud_equipo_cdgo] IS NULL \n";
        }
        try {
