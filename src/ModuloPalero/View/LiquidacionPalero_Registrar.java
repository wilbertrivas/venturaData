...
public class LiquidacionPalero_Registrar extends javax.swing.JPanel implements ActionListener, TableModelListener {
    ...
    private void initComponents() {
        ...
        add(sendMailIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 60, 40, 50));
        ...
        add(senMailLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 40, 50, 20));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 60, 50, 10));
        ...
        jLabel9.setText("GENERACIÓN DE LIQUIDACIÓN PALEROS");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Img/selectorCamposAplicarConfig.png"))); // NOI18N
        jButton1.setText("GENERAR LIQUIDACIÓN");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 460, 250, 50));
            ...
            try {
                ...
                if (fila1 == -1) {
                    ...
                    if (listado != null) {
                        ...
                        //Cargamos la liquidación y e consolidado
                        if(listadoPlantillaArchivoLiquidacion!= null){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!generandoLiquidacion){
            generandoLiquidacion=true;
            jButton1.setEnabled(false);
            if(configuracionLiquidacion != null && listadoPlantillaArchivoLiquidacion != null){
                ArrayList<Liquidacion> listadoLiquidacion = new ControlDB_LiquidacionPalero(tipoConexion).consultarPreLiquidacion(configuracionLiquidacion);
                ArrayList<ConsolidadoLiquidacion> listadoConsolidadoLiquidacion = new ControlDB_LiquidacionPalero(tipoConexion).consultarConsolidadoPreLiquidacion(configuracionLiquidacion);
                if(listadoLiquidacion != null && listadoConsolidadoLiquidacion != null){
                    try {
                        int result=new ControlDB_LiquidacionPalero(tipoConexion).registrar_Liquidacion(listadoLiquidacion,listadoConsolidadoLiquidacion,user);
                        if(result == 1){
                            ...
                            if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
                                ...
                                if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                                    ...
                                    Sheet hoja= wb.createSheet("Luquidación");
                            ...
                            JOptionPane.showMessageDialog(null,"Debe cargar una Preliquidación en el sistema para generar la liquidación", "Advertencia",JOptionPane.INFORMATION_MESSAGE);
                        }   
                    } catch (FileNotFoundException | UnknownHostException | SocketException | SQLException ex) {
            ...
            //Actualizamos la tabla de busque de configuraciones de liquidaciones
            paginationPanel.removeAll();
            validar();
            generarListadoMvtoCarbon();
                            
            
            //terminó el proceso de liquidación de palero.
            generandoLiquidacion=false;
            ...
            if(user.getCorreo().equals("")){
                ...
                try{
                    ...
                    try {
                        ...
                        texto.setText("Liquidaicón de paleros generada desde VenturaData");
