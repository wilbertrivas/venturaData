...
public class LiquidacionPalero_ConsultarConsolidadoPorPeriodo extends javax.swing.JPanel implements ActionListener, TableModelListener {
    Usuario user;
    ...
    int level = 0;
    boolean generandoLiquidacion= false;

    public LiquidacionPalero_ConsultarConsolidadoPorPeriodo(Usuario us, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(icon_exportar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 60, 50, 50));
        ...
        add(label_exportar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 40, 50, 20));
        ...
        add(sendMailIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 60, 40, 50));
        ...
        add(senMailLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 40, 50, 20));
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 60, 100, 10));

        jSeparator2.setOrientation(javax.swing.SwingConstants.VERTICAL);
        add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 40, 10, 70));

        jLabel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 40, 510, 70));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 102, 102));
        jLabel8.setText("SELECCIONE PERIODO DE LIQUIDACIÓN:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 250, 30));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 1390, 340));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("CONSULTA DE CONSOLIDADOS DE LIQUIDACIÓN PALEROS");
        jLabel9.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 1390, 30));

        jLabel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 1390, 70));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 102, 102));
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 1390, 70));

        jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);
        add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 40, 10, 70));
        ...
        try {
            ...
            if (fila1 == -1) {
                ...
                if (listado != null) {
                    ...
                    listadoConsolidadoLiquidacion= new ControlDB_LiquidacionPalero(tipoConexion).consultarConsolidadoLiquidacion(configuracionLiquidacion);
                    if(listadoConsolidadoLiquidacion!= null){
                       
                        DefaultTableModel modeloT = new DefaultTableModel(null, new String[]{"FECHA", "CUADRILLA", "DOCUMENTO", "EMPLEADO", "KILO", "DIAS LABORADOS", "DCTO TONELADA MES", "VALOR TONELADA","TONELADA SALARIO","TONELADAS A PAGAR","TOTAL COMISION","PLACAS"});
                        ...
                        for(ConsolidadoLiquidacion objeto : listadoConsolidadoLiquidacion){
                            ...
                            registro[0] = "" + objeto.getFecha();
                            registro[1] = "" + objeto.getPersona().getEquipo().getDescripcion()+ " "+objeto.getPersona().getEquipo().getModelo();
                            registro[2] = "" + objeto.getPersona().getCodigo();
                            registro[3] = "" + objeto.getPersona().getNombre()+ " "+ objeto.getPersona().getApellido();
                            registro[4] = "" + objeto.getCantidadToneladasAsignadas();
                            registro[5] = "" + objeto.getDia();
                            registro[6] = "" + configuracionLiquidacionliquidar.getCantidadToneladaSalario();
                            registro[7] = "" + configuracionLiquidacionliquidar.getValorTonelada();
                            registro[8] = "" + configuracionLiquidacionliquidar.getCantidadToneladaSalario();
                            registro[9] = "" + (Double.parseDouble(objeto.getCantidadToneladasAsignadas()) - configuracionLiquidacionliquidar.getCantidadToneladaSalario());
                            registro[10] = "" + ((Double.parseDouble(objeto.getCantidadToneladasAsignadas()) - configuracionLiquidacionliquidar.getCantidadToneladaSalario()) *configuracionLiquidacionliquidar.getValorTonelada());
                            registro[11] = "" + objeto.getDescripcionVehiculosDescargados();
...
/*        if(listadoPlantillaArchivoLiquidacion != null){
            if(user.getCorreo().equals("")){
                ...
                try{
                    ...
                    celda2.setCellValue(configuracionLiquidacionliquidar.getDescripcion());
                    ...
                    try {
                        ...
                        adjunto.setFileName(""+configuracionLiquidacionliquidar.getDescripcion()+".xlsx");
            ...
            JOptionPane.showMessageDialog(null, "Debe cargar una liquidación","Error!!", JOptionPane.INFORMATION_MESSAGE);
        }*/
    ...
    private void icon_exportarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_icon_exportarMouseClicked
        /*if(listadoPlantillaArchivoLiquidacion != null){
            //Generación de documento en Excel
            ArrayList<String> encabezadoTabla= new ArrayList<>();
            encabezadoTabla.add("FECHA INICIO PERIODO");
            encabezadoTabla.add("FECHA FIN PERIODO");
            encabezadoTabla.add("CUADRILLA");
            ...
            if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
                ...
                if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                    ...
                    Sheet hoja= wb.createSheet("Liquidación");
                    int costoTotalApuntador=300000;
                    try{
                        Row fila2= hoja.createRow(0);
                        Cell celda2= fila2.createCell(0);
    ...
    public void tabla_Listar(String data1, String data2) throws SQLException {
        ...
        listado = new ControlDB_ConfiguracionLiquidacion(tipoConexion).buscarConfiguracionesLiquidacionesLiquidadas(data1, data2);
        if (listado != null) {
