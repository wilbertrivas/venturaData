...
import ModuloCarbon.View.Worker_MvtonCarbon;
...
public class LiquidacionPalero_Registrar_backup extends javax.swing.JPanel implements ActionListener, TableModelListener {
    Usuario user;
    ...
    public LiquidacionPalero_Registrar_backup(Usuario us, String tipoConexion) {
        initComponents();
        user = us;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("SELECCIONE PERIODO DE LIQUIDACIÓN:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 250, 30));
        ...
        add(icon_buscarClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 30, 30));
        ...
        add(icon_buscarClientes1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 30, 30));
        ...
        add(label_configuracionLiquidacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 50, 680, 30));

        jButton1.setBackground(new java.awt.Color(255, 255, 255));
        jButton1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/procesarCcarga.png"))); // NOI18N
        jButton1.setText("CARGAR VEHÍCULOS DESCARGADOS EN EL PERIODO DE LA LIQUIDACIÓN");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 560, 40));
        ...
        add(Label_level, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 110, 420, 30));
        ...
        add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 1390, 20));
        ...
        if (configuracionLiquidacion != null) {//validamos que se tenga cargada una configuración de liquidación
            ...
            if (opcion == 0) {//El usuario selección la opción si, que desea generar la liquidación para el periodo seleccionado.
                try {
                    ...
                    Logger.getLogger(LiquidacionPalero_Registrar_backup.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void buttonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNextActionPerformed
        if (!validarNext) {
            ...
            if (level == 1) {
                ...
                if(listado!=null){
                    Worker_PaleroMarcacionPersonas  worker = new Worker_PaleroMarcacionPersonas (jProgressBar1,buttonNext,listadoMvtoCarbon_ListadoEquipos_LiquidacionPaleros, user,tipoConexion);
                    worker.execute();
