...
public class LiquidacionPalero_Consultar extends javax.swing.JPanel implements ActionListener, TableModelListener {
    Usuario user;
    ...
    public LiquidacionPalero_Consultar(Usuario us, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("CONSULTA DE LIQUIDACIÓN DE PALEROS");
        ...
        try {
            ...
            if (fila1 == -1) {
                ...
                if (listado != null) {
                    ...
                    listadoPlantillaArchivoLiquidacion= new ControlDB_LiquidacionPalero(tipoConexion).consultar_Liquidacion(configuracionLiquidacion);
