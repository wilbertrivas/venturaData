...
public final class EquipoTarifa_Consultar extends javax.swing.JPanel {
    ArrayList<Equipo> listado=null;
    DefaultTableModel modeloCliente;
    Usuario user;
    private String tipoConexion;
    public EquipoTarifa_Consultar(Usuario us,String tipoConexion) {
        initComponents();
        user=us;
        ...
        try {
            ...
            Logger.getLogger(EquipoTarifa_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void tabla_Listar(String sql, String busquedaEspecifica) throws SQLException{
        ...
        Stitulo +="Año Anterior:ValorHoraOperación Anterior:ValorHoraAlquiler Anterior";
            contador=contador + 3;
