...
public final class Equipo_Tarifa extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    private void initComponents() {
        ...
        Tarifa_costo_LavadoVehículo = new javax.swing.JRadioButton();
        Tarifa_recaudoEmpresa_LavadoVehículo = new javax.swing.JRadioButton();
        Tarifa_recaudoEquipo_LavadoVehículo = new javax.swing.JRadioButton();
        ...
        equipo_descripción.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternalFrame_RegistroTarifa.getContentPane().add(equipo_descripción, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 100, 680, -1));
        ...
        InternalFrame_RegistroTarifa.getContentPane().add(equipo_valorHoraOperación, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 350, 210, 30));
        ...
        titulo52.setText("Costo Lavado Vehículo:");
        ...
        Tarifa_costo_LavadoVehículo.setBackground(new java.awt.Color(255, 255, 255));
        Tarifa_costo_LavadoVehículo.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        Tarifa_costo_LavadoVehículo.setForeground(new java.awt.Color(51, 51, 51));
        Tarifa_costo_LavadoVehículo.setText("Tarifa_Costo_LavadoVehículo");
        Tarifa_costo_LavadoVehículo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        InternalFrameSelectorCampos.getContentPane().add(Tarifa_costo_LavadoVehículo, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 270, 190, -1));

        Tarifa_recaudoEmpresa_LavadoVehículo.setBackground(new java.awt.Color(255, 255, 255));
        Tarifa_recaudoEmpresa_LavadoVehículo.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        Tarifa_recaudoEmpresa_LavadoVehículo.setForeground(new java.awt.Color(51, 51, 51));
        Tarifa_recaudoEmpresa_LavadoVehículo.setText("Tarifa_Valor_RecaudoEmpresa por LavadoVehículo");
        Tarifa_recaudoEmpresa_LavadoVehículo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        InternalFrameSelectorCampos.getContentPane().add(Tarifa_recaudoEmpresa_LavadoVehículo, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 290, 300, -1));

        Tarifa_recaudoEquipo_LavadoVehículo.setBackground(new java.awt.Color(255, 255, 255));
        Tarifa_recaudoEquipo_LavadoVehículo.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        Tarifa_recaudoEquipo_LavadoVehículo.setForeground(new java.awt.Color(51, 51, 51));
        Tarifa_recaudoEquipo_LavadoVehículo.setText("Tarifa_Valor_RecaudoEquipo por LavadoVehículo");
        Tarifa_recaudoEquipo_LavadoVehículo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        InternalFrameSelectorCampos.getContentPane().add(Tarifa_recaudoEquipo_LavadoVehículo, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 310, 300, -1));
                                ...
                                if(i==-1){
                                    ...
                                    switch(encabezadoTabla.get(j)){
                                        ...
                                        case "TipoEquipo_Código":{
                                         ...
                                         case "Tarifa_Costo_LavadoVehículo":{
                                        ...
                                        try{
                                            if(!equipo_costoLavado.getText().equals("")){
                                                ...
                                                try{
                                                    if(!equipo_recaudoEmpresa.getText().equals("")){
                                                        ...
                                                        try{
                                                            if(!equipo_recaudoEquipo.getText().equals("")){
                                                                ...
                                                                try{
                                                                    //Costo del lavado para los vehículos.
                                                                    if(equipo_costoLavado.getText().equals("")){
                                                                    ...
                                                                    //valor del recaudo para la empresa según costo de lavado del vehiculo
                                                                    if(equipo_recaudoEmpresa.getText().equals("")){
                                                                        tarifaEquipoNueva.setValorRecaudoEmpresa("0");
                                                                    }else{
                                                                        if(Integer.parseInt(equipo_recaudoEmpresa.getText())<0){
                                                                            validar=false;  
                                                                            JOptionPane.showMessageDialog(null, "El valor del recaudado por la empresa según costo del lavado no puede ser negativo", "Error!!", JOptionPane.ERROR_MESSAGE);
                                                                        }else{
                                                                            tarifaEquipoNueva.setValorRecaudoEmpresa(equipo_recaudoEmpresa.getText());
                                                                        }
                                                                    }   
                                                                    
                                                                    //valor del recaudo para el equipo según costo de lavado del vehiculo.
                                                                    if(equipo_recaudoEquipo.getText().equals("")){
                                                                        tarifaEquipoNueva.setValorRecaudoEquipo("0");
                                                                    }else{
                                                                        if(Integer.parseInt(equipo_recaudoEquipo.getText())<0){
                                                                            validar=false;  
                                                                            JOptionPane.showMessageDialog(null, "El valor del recaudado por el equipo según costo del lavado no puede ser negativo", "Error!!", JOptionPane.ERROR_MESSAGE);
                                                                        }else{
                                                                ...
                                                                if(validar){
                                                                    ...
                                                                    JOptionPane.showMessageDialog(null, "El valor del lavado de vehículo debe ser númerico y no puede ser negativo");
                                                                }
                                                            }else{
                                                                JOptionPane.showMessageDialog(null,"El valor del recaudo del equipo no puede estar vacio","Error!!",JOptionPane.ERROR_MESSAGE);  
                                                            }
                                                        }catch(Exception e){
                                                            JOptionPane.showMessageDialog(null,"El valor del recaudo del equipo debe ser númerico y no puede contener punto","Error!!",JOptionPane.ERROR_MESSAGE);  
                                                        }
                                                    }else{
                                                    ...
                                                    JOptionPane.showMessageDialog(null,"El valor del recaudo de la empresa debe ser númerico y no puede contener punto","Error!!",JOptionPane.ERROR_MESSAGE);  
                                                }
                                            }else{
                                                JOptionPane.showMessageDialog(null,"El costo del lavado de vehículo no puede estar vacio","Error!!",JOptionPane.ERROR_MESSAGE);  
                                            }
                                        }catch(Exception e){
                                            JOptionPane.showMessageDialog(null,"El costo del lavado de vehículo debe ser númerico y no puede contener punto","Error!!",JOptionPane.ERROR_MESSAGE);  
                                        }        
                                    }else{
    ...
    private void select_costoLavadoVehiculoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_select_costoLavadoVehiculoItemStateChanged
        if((select_costoLavadoVehiculo.isSelected())){//El usuario está seleccionando el check
    ...
    private void select_valorRecaudoEmpresaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_select_valorRecaudoEmpresaItemStateChanged
        if((select_valorRecaudoEmpresa.isSelected())){//El usuario está seleccionando el check
    ...
    private void select_valorRecaudoEquipoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_select_valorRecaudoEquipoItemStateChanged
        if((select_valorRecaudoEquipo.isSelected())){//El usuario está seleccionando el check
    ...
    private javax.swing.JRadioButton Tarifa_costo_LavadoVehículo;
    private javax.swing.JRadioButton Tarifa_recaudoEmpresa_LavadoVehículo;
    private javax.swing.JRadioButton Tarifa_recaudoEquipo_LavadoVehículo;
    ...
    public void selectorCampoPorDefecto(){
        ...
        Tarifa_costo_LavadoVehículo.setSelected(true); 
        Tarifa_recaudoEmpresa_LavadoVehículo.setSelected(true); 
        Tarifa_recaudoEquipo_LavadoVehículo.setSelected(true); 
    }
    ...
    public void selectorCampoNinguno(){
        ...
        Tarifa_costo_LavadoVehículo.setSelected(false); 
        Tarifa_recaudoEmpresa_LavadoVehículo.setSelected(false); 
        Tarifa_recaudoEquipo_LavadoVehículo.setSelected(false); 
    }  
    ...
    public void validarSeleccionCampos(){
        ...
        if(Tarifa_costo_LavadoVehículo.isSelected()){
                encabezadoTabla.add("Tarifa_Costo_LavadoVehículo");
        }
        if(Tarifa_recaudoEmpresa_LavadoVehículo.isSelected()){
                encabezadoTabla.add("Tarifa_Valor_RecaudoEmpresa");
        }
        if(Tarifa_recaudoEquipo_LavadoVehículo.isSelected()){
