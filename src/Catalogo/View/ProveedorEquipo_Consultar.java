...
public final class ProveedorEquipo_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public ProveedorEquipo_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(ProveedorEquipo_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE PROVEEDOR DE EQUIPOS");
