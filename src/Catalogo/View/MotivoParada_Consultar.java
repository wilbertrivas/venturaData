...
public final class MotivoParada_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public MotivoParada_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MotivoParada_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE MOTIVOS DE PARADA");
