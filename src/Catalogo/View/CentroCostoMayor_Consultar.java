...
public final class CentroCostoMayor_Consultar extends javax.swing.JPanel {
    ...
    Usuario user;
    public CentroCostoMayor_Consultar(Usuario u,String tipoConexion) {
        initComponents();
         user= u;
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 1400, 310));
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, 140, 40));
        ...
        jLabel3.setText("CONSULTA DE CENTRO DE COSTOS MAYORES");
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        try {
            ...
            Logger.getLogger(CentroCostoMayor_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                ...
                Sheet hoja= wb.createSheet("CentroCostosMayoresVenturaData");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if(user.getCorreo().equals("")){
            ...
            File archivo;
            //archivo= new File( "reportes/"+user.getCodigo()+"_"+"reporte_CentroCostosMayores.xlsx");
            archivo= new File( System.getProperty("java.io.tmpdir")+user.getCodigo()+"_"+"reporte_CentroCostosMayores.xlsx");
            Workbook wb;
            String respuesta="No se realizó con exito la exportacion";
            int numFila=tabla.getRowCount(), numColumna=tabla.getColumnCount();
            if(archivo.getName().endsWith("xls")){
            ...
            Sheet hoja= wb.createSheet("ReporteVenturaData_CentroCostosMayores");
            int costoTotalApuntador=300000;
            try{
                for(int i= -1; i < numFila; i++ ){
                    Row fila= hoja.createRow(i+1);
                ...
                try {
                    ...
                    adjunto.setFileName("reporte_VenturaData_CentroCostosMayores.xlsx");
