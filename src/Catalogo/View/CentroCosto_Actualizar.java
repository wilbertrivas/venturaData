...
public class CentroCosto_Actualizar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACTUALIZACIÓN DE CENTRO DE COSTO");
    ...
    public void tabla_Listar(String valorConsulta) throws SQLException{             
        DefaultTableModel modelo = new DefaultTableModel(null, new String[]{"Código", "Cliente","CentroOperación","SubcentroCosto","C.C. Auxiliar","LaborRealizada","Descripción","Base De Datos" ,"Estado"});  
