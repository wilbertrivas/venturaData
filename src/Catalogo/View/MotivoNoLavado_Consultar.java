...
public final class MotivoNoLavado_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public MotivoNoLavado_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MotivoNoLavado_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE MOTIVOS DEL NO LAVADO VEHÍCULO");
        add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 620, 30));
