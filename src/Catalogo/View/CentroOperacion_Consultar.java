...
public final class CentroOperacion_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public CentroOperacion_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(CentroOperacion_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE CENTRO DE OPERACIÓN");
