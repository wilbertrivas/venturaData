...
public final class Motonave_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    Usuario user;
    public Motonave_Consultar(Usuario u,String tipoConexion) {
        initComponents();
        user= u;
        ...
        try {
            ...
            Logger.getLogger(Motonave_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 1440, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 1440, 500));
        add(valorBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 450, 40));
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, 140, 40));
        ...
        add(btn_cancelar_cliente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 40, 140, 40));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 50, 50, 40));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 102, 102));
        jLabel14.setText("Exportar");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 40, 60, 10));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 102, 102));
        jLabel16.setText("Correo");
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 40, 90, 10));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 50, 40, 40));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 1440, 100));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                ...
                Sheet hoja= wb.createSheet("MotonavesVenturaData");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if(user.getCorreo().equals("")){
            ...
            Sheet hoja= wb.createSheet("ReporteVenturaData_Motonaves");
            int costoTotalApuntador=300000;
            try{
                for(int i= -1; i < numFila; i++ ){
                    Row fila= hoja.createRow(i+1);
                ...
                try {
                    ...
                    adjunto.setFileName("reporte_VenturaData_Motonaves.xlsx");
