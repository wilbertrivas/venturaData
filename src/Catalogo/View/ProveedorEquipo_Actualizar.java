...
public final class ProveedorEquipo_Actualizar extends javax.swing.JPanel {
     
    Usuario user;
    private String tipoConexion;
    public ProveedorEquipo_Actualizar(Usuario us, String tipoConexion) {
        user=us;
        ...
        try {
            ...
            Logger.getLogger(ProveedorEquipo_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACTUALIZACIÓN DE PROVEEDORES DE EQUIPOS");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(codigo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error.. Se debe carga un proveedor de equipo", "Advertencia", JOptionPane.ERROR_MESSAGE);
        }
        else{
            if(nombre.getText().equals("")){
                ...
                try {
                    if(!new ControlDB_ProveedorEquipo(tipoConexion).validarExistenciaActualizar(Objeto)){
                        int respuesta=new ControlDB_ProveedorEquipo(tipoConexion).actualizar(Objeto, user);
                        if(respuesta==1){
                            JOptionPane.showMessageDialog(null, "Se actualizo el proveedor de equipo");
                            nombre.setText("");
                            estado.setSelectedIndex(0);
                            tabla_Listar("");
                            codigo.setText("");
                            ...
                            if(respuesta==0){
                                JOptionPane.showMessageDialog(null, "No se pudo actualizar el proveedor de equipo, valide los datos ingresados");
                            }
                        }
                    }else{
                        JOptionPane.showMessageDialog(null, "Ya existe un proveedor de equipo en el sistema registrado con el mismo nombre, valide los datos ingresados", "Advertencia", JOptionPane.ERROR_MESSAGE);
                    }
    ...
    public void tabla_Listar(String valorConsulta) throws SQLException{      
        ...
        ArrayList<ProveedorEquipo> listadoProveedorEquipoR=new ControlDB_ProveedorEquipo(tipoConexion).buscar(valorConsulta);
        for(ProveedorEquipo listadoProveedorEquipo:listadoProveedorEquipoR){
            String []registro = new String[3];
            registro[0]=""+listadoProveedorEquipo.getCodigo();
            registro[1]=""+listadoProveedorEquipo.getDescripcion();
            registro[2]=""+listadoProveedorEquipo.getEstado();            
