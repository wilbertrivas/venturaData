...
public final class Transportadora_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    Usuario user;
    
    public Transportadora_Consultar(Usuario u, String tipoConexion) {
        initComponents();  
        user= u;
        ...
        try {
            ...
            Logger.getLogger(Transportadora_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 1280, 10));

        titulo.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        titulo.setText("CONSULTA DE TRANSPORTADORAS");
        add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1290, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 1280, 470));
        add(valorBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 280, 30));
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 60, 150, 40));
        ...
        add(btn_cancelar_cliente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 60, 140, 40));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 60, 50, 40));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 102, 102));
        jLabel14.setText("Exportar");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 50, 60, 10));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 102, 102));
        jLabel16.setText("Correo");
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 50, 90, 10));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 60, 40, 40));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1280, 100));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                ...
                Sheet hoja= wb.createSheet("TransportadorasVenturaData");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if(user.getCorreo().equals("")){
            ...
            File archivo;
            //archivo= new File( "reportes/"+user.getCodigo()+"_"+"reporte_Transportadora.xlsx");
            archivo= new File( System.getProperty("java.io.tmpdir")+user.getCodigo()+"_"+"reporte_Transportadora.xlsx");
            Workbook wb;
            String respuesta="No se realizó con exito la exportacion";
            int numFila=tabla.getRowCount(), numColumna=tabla.getColumnCount();
            if(archivo.getName().endsWith("xls")){
            ...
            Sheet hoja= wb.createSheet("ReporteVenturaData_Transportadoras");
            int costoTotalApuntador=300000;
            try{
                for(int i= -1; i < numFila; i++ ){
                    Row fila= hoja.createRow(i+1);
                ...
                try {
                    ...
                    adjunto.setFileName("reporte_VenturaData_Transportadoras.xlsx");
