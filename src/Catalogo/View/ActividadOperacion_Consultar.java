...
public final class ActividadOperacion_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public ActividadOperacion_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(ActividadOperacion_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE ACTIVIDADES OPERACIONALES");
