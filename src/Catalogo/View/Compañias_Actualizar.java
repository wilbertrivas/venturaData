...
public final class Compañias_Actualizar extends javax.swing.JPanel {
    Usuario user;
    private String tipoConexion;
    public Compañias_Actualizar(Usuario us,String tipoConexion) {
        user=us;
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(Compañias_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(codigo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error.. Se debe carga una compañia", "Advertencia", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            if(nombre.getText().equals("")){
                alerta_nombre.setText("El nombre de la compañia no puede estar vacio");
            }else{
                ...
                try {
                    if(!new ControlDB_Compañia(tipoConexion).validarExistenciaActualizar(Objeto)){
                        int respuesta=new ControlDB_Compañia(tipoConexion).actualizar(Objeto, user);
                        if(respuesta==1){
                            JOptionPane.showMessageDialog(null, "Se actualizo la compañia");
                            codigo.setText("");
                            nombre.setText("");
                            estado.setSelectedIndex(0);
                            tabla_Listar("");
                            ...
                            if(respuesta==0){
                                JOptionPane.showMessageDialog(null, "No se pudo actualizar la compañia, valide los datos ingresados");
                            }
                        }
                    }else{
                        JOptionPane.showMessageDialog(null, "Ya existe una compañia con el mismo nombre, valide los datos ingresados", "Advertencia", JOptionPane.ERROR_MESSAGE);
                    }
                    
                } catch (FileNotFoundException ex) {
                    JOptionPane.showMessageDialog(null, "Error al registrar la compañia");
                    Logger.getLogger(Compañias_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
                } catch (SQLException ex) {
                    Logger.getLogger(Compañias_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void tabla_Listar(String valorConsulta) throws SQLException{
        ...
        ArrayList<Compañia> listado=new ControlDB_Compañia(tipoConexion).buscar(valorConsulta);
        for (Compañia listado1 : listado) {
