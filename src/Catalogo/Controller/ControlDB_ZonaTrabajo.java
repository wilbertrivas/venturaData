...
public class ControlDB_ZonaTrabajo {
    ...
    public int registrar(ZonaTrabajo Objeto, Usuario us) throws FileNotFoundException, UnknownHostException, SocketException{
        ...
        try{
            ...
            PreparedStatement Query= conexion.prepareStatement("INSERT INTO ["+DB+"].[dbo].[debito_lavado_vehiculo]\n" +
                                                            "           ([dlv_cdgo]\n" +
                                                            "           ,[dlv_fecha_debito]\n" +
                                                            ...
                                                            "           ,?--<dlv_fecha_debito, date,>\n" +
                                                            "           ,?--<dlv_zona_trabajo_cdgo, int,>\n" +
                                                            "           ,?--<dlv_valor, int,>\n" +
                                                            "           ,?--<dlv_desc, varchar(100),>\n" +
                                                            "           ,1--1\n" +
                                                            "           ,usuario\n" +
                                                            "           ,(SELECT SYSDATETIME()));");
