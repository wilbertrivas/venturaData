...
public final class ActividadOperacion_Actualizar extends javax.swing.JPanel {
    Usuario user;
    private String tipoConexion;
    public ActividadOperacion_Actualizar(Usuario us, String tipoConexion) {
        user=us;
        initComponents();
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error al tratar de consultar las actividades operacionales");
            Logger.getLogger(ActividadOperacion_Actualizar.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACTUALIZACIÓN DE ACTIVIDADES OPERACIONALES");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(codigo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error.. Se debe carga una actividad operacional", "Advertencia", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            if(nombre.getText().equals("")){
                ...
                try {
                    if(!new ControlDB_ActividadOperacion(tipoConexion).validarExistenciaActualizar(Objeto)){
                        int respuesta=new ControlDB_ActividadOperacion(tipoConexion).actualizar(Objeto, user);
                        if(respuesta==1){
                            JOptionPane.showMessageDialog(null, "Se actualizo la actividad operacional");
                            nombre.setText("");
                            estado.setSelectedIndex(0);
                            tabla_Listar("");
                            codigo.setText("");
                            ...
                            if(respuesta==0){
                                JOptionPane.showMessageDialog(null, "No se pudo actualizar la actividad operacional, valide los datos ingresados");
                            }
                        }
                    }else{
    ...
    public void tabla_Listar(String valorConsulta) throws SQLException{      
        ...
        ArrayList<ActividadOperacion> listadoProcedenciaEquipoR=new ControlDB_ActividadOperacion(tipoConexion).buscar(valorConsulta);
        for(ActividadOperacion listadoProcedenciaEquipo:listadoProcedenciaEquipoR){
