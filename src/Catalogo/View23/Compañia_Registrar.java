...
public final class Compañia_Registrar extends javax.swing.JPanel {
  
    Usuario user;
    private String tipoConexion;
    public Compañia_Registrar(Usuario us,String tipoConexion) {
        user=us;
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(Compañia_Registrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 70, 750, 360));
         ...
         if(nit.getText().equals("")){
            ...
            try{
                ...
                if(nombre.getText().equals("")){
                    ...
                    Objeto.setCodigo(nit.getText()+"-"+digitoVerificacion.getText());
                    ...
                    try {
                        if(new ControlDB_Compañia(tipoConexion).validarPorCodigo(Objeto)){
                            JOptionPane.showMessageDialog(null, "La Compañia ya se encuentra registrada en el sistema");
                        }else{
                            int respuesta=new ControlDB_Compañia(tipoConexion).registrar(Objeto,user);
                            if(respuesta==1){
                                JOptionPane.showMessageDialog(null, "Se registro la Compañia de forma exitosa");
                                nit.setText("");
                                ...
                                if(respuesta==0){
                                    JOptionPane.showMessageDialog(null, "No se pudo registrar la Compañia, valide datos");
                                }
                            }
                        }
