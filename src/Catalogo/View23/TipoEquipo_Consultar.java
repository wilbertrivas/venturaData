...
public final class TipoEquipo_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public TipoEquipo_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(TipoEquipo_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE TIPO DE EQUIPOS");
