...
public final class CausaInactividad_Consultar extends javax.swing.JPanel {
    private String tipoConexion;
    public CausaInactividad_Consultar(String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(CausaInactividad_Consultar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("CONSULTA DE CAUSAS DE INACTIVIDAD");
