...
public final class Motonave_RegistroSincronizado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 1460, 30));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 1460, 600));
        add(valorBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 60, 290, 40));
        ...
        add(consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 60, 170, 40));
        ...
        add(sincronizarCcarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 60, 250, 40));

        jProgressBar1.setStringPainted(true);
        add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 1440, 30));
        ...
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1340, 70, 50, 40));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 102, 102));
        jLabel14.setText("Exportar");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(1340, 60, 60, 10));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 102, 102));
        jLabel16.setText("Correo");
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(1400, 60, 90, 10));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1400, 70, 40, 40));
        ...
        add(btn_cancelar_cliente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 60, 140, 40));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Base de Datos:");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 110, 40));

        listado_baseDatos.setToolTipText("");
        add(listado_baseDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 300, 40));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 1460, 130));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(selecArchivo.showDialog(null, "Exportar") ==JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")){
                ...
                Sheet hoja= wb.createSheet("MotonavesCCARGA");
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        if(user.getCorreo().equals("")){
            ...
            Sheet hoja= wb.createSheet("ReporteVenturaData_MotonavesCcarga");
            int costoTotalApuntador=300000;
            try{
                for(int i= -1; i < numFila; i++ ){
                    Row fila= hoja.createRow(i+1);
                ...
                try {
                    ...
                    adjunto.setFileName("reporte_VenturaData_MotonavesCCARGA.xlsx");
    ...
    public void tabla_Listar(String valorConsulta, BaseDatos db) throws SQLException{
        ...
        if(db.getCodigo().equals("1")){//Base de datos grupoportuario
            ...
            if(db.getCodigo().equals("2")){//Base de datos oppgraneles
                listado=new ControlDB_Motonave(tipoConexion).buscarMotonaveOPP(valorConsulta);
            }
        }
