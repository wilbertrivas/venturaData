            ...
            if(!validarPorDescripcion(Objeto)){
                ...
                if(!validarPorCodigo(Objeto)){
                    ...
                    if(result==1){
                        ...
                        Query_Auditoria.setString(6, "'Se registró un nuevo tipo de documento en el sistema, con Código: '");
                    ...
                    JOptionPane.showMessageDialog(null, "Ya existe un tipo de documento con ese código");
                }
            }else{
