...
public class Jornada_Actualizar extends javax.swing.JPanel {
    Usuario user;
    private String tipoConexion;
    ArrayList<Jornada> listadoJornada = null;
    public Jornada_Actualizar(Usuario us, String tipoConexion) {
        initComponents();
        user = us;
    ...
    private void initComponents() {
        ...
        setComponentPopupMenu(Seleccionar);
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 110, 630, 480));
        ...
        jLabel2.setText("ACTUALIZACIÓN DE JORNADA");
        ...
        if (evt.getClickCount() == 2) {
            ...
            try{
                ...
                if(fila1==-1){
                    ...
                    codigo.setText(listadoJornada.get(fila1).getCodigo());
                    nombre.setText(listadoJornada.get(fila1).getDescripcion());
                    if(listadoJornada.get(fila1).getEstado().equals("ACTIVO")){
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(codigo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error.. Se debe cargar una jornada", "Advertencia", JOptionPane.INFORMATION_MESSAGE);
        }else{
            if(nombre.getText().equals("")){
                alerta_nombre.setText("El nombre de la jornada no puede estar vacio");
            }else{
                Jornada jornada = new Jornada();
                jornada.setCodigo(codigo.getText());
                jornada.setDescripcion(nombre.getText());
                ...
                try {
                    if(!new ControlDB_Jornada(tipoConexion).validarExistenciaActualizar(jornada)){
                        int respuesta=new ControlDB_Jornada(tipoConexion).actualizar(jornada, user);
                        if(respuesta==1){
                            JOptionPane.showMessageDialog(null, "Se actualizó la Jornada de forma exitosa");
                            nombre.setText("");
                            estado.setSelectedIndex(0);
                            tabla_Listar("");
                            codigo.setText("");
                            ...
                            if(respuesta==0){
                                JOptionPane.showMessageDialog(null, "No se pudo actualizar la jornada, valide los datos ingresados");
                            }
                        }
                    }else{
                        JOptionPane.showMessageDialog(null, "Ya existe una jornada con ese mismo nombre, valide información", "Advertencia",JOptionPane.ERROR_MESSAGE);
                    }
    ...
    // End of variables declaration//GEN-END:variables
     ...
     public void tabla_Listar(String valorConsulta) throws SQLException{
        ...
        listadoJornada =new ControlDB_Jornada(tipoConexion).buscar(valorConsulta);
        for (Jornada object : listadoJornada) {
