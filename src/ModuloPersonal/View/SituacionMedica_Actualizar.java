...
public final class SituacionMedica_Actualizar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ACTUALIZACIÓN DE SITUACIÓN MÉDICA");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        if(codigo.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error.. Se debe cargar una situación médica", "Advertencia", JOptionPane.INFORMATION_MESSAGE);
        }else{
            if(nombre.getText().equals("")){
                alerta_nombre.setText("El nombre de la situación médica no puede estar vacio");
            }else{
                ...
                try {
                    if(!new ControlDB_SituacionMedica(tipoConexion).validarExistenciaActualizar(situacionMedica)){
                        ...
                        if(respuesta==1){
                            JOptionPane.showMessageDialog(null, "Se actualizó la situación médica de forma exitosa");
                            nombre.setText("");
                            estado.setSelectedIndex(0);
                            tabla_Listar("");
                            codigo.setText("");
                            ...
                            if(respuesta==0){
                                JOptionPane.showMessageDialog(null, "No se pudo actualizar la situación médica, valide los datos ingresados");
                            }
                        }
                    }else{
                        JOptionPane.showMessageDialog(null, "Ya existe una situación médica con ese mismo nombre, valide información", "Advertencia",JOptionPane.ERROR_MESSAGE);
                    }
                    
                } catch (FileNotFoundException ex) {
                    JOptionPane.showMessageDialog(null, "Error al registrar la situación médica");
