...
public final class MvtoCarbon_Activar_Final extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    public MvtoCarbon_Activar_Final(Usuario user, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Activar = new javax.swing.JPopupMenu();
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 710, 170, 40));
        ...
        jLabel58.setText("DATOS DEL MOVIMIENTO DE CARBÓN A ACTIVAR");
        ...
        tabla.setComponentPopupMenu(Activar);
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 1300, 590));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(observacion_autorizacionMvtoCarbon.getText().equals("")){
            ...
            int retorno = 0;
            try {
                retorno = new ControlDB_MvtoCarbon(tipoConexion).ActivarVehiculoEnMvtoCarbon(mvtoCarbon, listadoMvtoCarbon_ListadoEquipos, user,observacion_autorizacionMvtoCarbon.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(MvtoCarbon_Activar_Final.class.getName()).log(Level.SEVERE, null, ex);
            ...
            if(retorno==1){
                JOptionPane.showMessageDialog(null, "Se activo el descargue del equipo de forma exitosa", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JPopupMenu Activar;
    ...
    public void tabla_Listar(String data1, String data2) throws SQLException{
        tabla.setModel(crearModeloDeTabla());
        listado=new ControlDB_MvtoCarbon(tipoConexion).buscarMvtoCarbonUnicos_Inactivos(data1, data2);
        proveedorDeDatos = crearProveedorDeDatos(listado); 
        paginadorDeTabla = new PaginadorDeTabla(tabla, proveedorDeDatos, new int[]{5, 10, 20, 50, 75, 100}, 10);
        paginadorDeTabla.crearListadoDeFilasPermitidas(this.paginationPanel);
        pageJComboBox = paginadorDeTabla.getComboBoxPage();
