...
public final class MvtoCarbon_ModificarFinal_Backup extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    public MvtoCarbon_ModificarFinal_Backup(Usuario user, String tipoConexion) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MvtoCarbon_ModificarFinal_Backup.class.getName()).log(Level.SEVERE, null, ex);
        }  
    ...
    private void initComponents() {
        ...
        add(checkUsuarioQuienRegistra, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 120, 200, 30));
