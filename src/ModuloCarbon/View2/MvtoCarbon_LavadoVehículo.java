...
public final class MvtoCarbon_LavadoVehículo extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    public MvtoCarbon_LavadoVehículo(Usuario user, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LavadoVehiculo = new javax.swing.JPopupMenu();
        ...
        observacion_LavadoVehículo = new javax.swing.JTextArea();
        jScrollPane4 = new javax.swing.JScrollPane();
        MvtCarbon_lavadoVehículoObservación = new javax.swing.JTextArea();
        titulo40 = new javax.swing.JLabel();
        titulo41 = new javax.swing.JLabel();
        lavadoVehículo = new javax.swing.JComboBox<>();
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 240, 370, 40));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(mvtEquipo_MotivoFinalización, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 490, 400, 20));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(mvtEquipo_UsuarioRegistro_Código, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 560, 400, 20));
        ...
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(mvtEquipo_Equipo_descripción, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 580, 370, 20));
        ...
        jLabel94.setText("Nom. Usuario Registró Descargue:");
        ...
        jLabel97.setText("Cod. Usuario Registró Descargue:");
        ...
        jLabel104.setText("Observación Lavado Vehículo:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jLabel104, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 300, 220, 20));
        ...
        observacion_LavadoVehículo.setColumns(20);
        observacion_LavadoVehículo.setRows(5);
        jScrollPane5.setViewportView(observacion_LavadoVehículo);
        ...
        MvtCarbon_lavadoVehículoObservación.setEditable(false);
        MvtCarbon_lavadoVehículoObservación.setColumns(20);
        MvtCarbon_lavadoVehículoObservación.setRows(5);
        jScrollPane4.setViewportView(MvtCarbon_lavadoVehículoObservación);

        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 300, 370, 30));

        titulo40.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo40.setForeground(new java.awt.Color(51, 51, 51));
        titulo40.setText("LAVADO DE VEHÍCULO:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(titulo40, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 710, 150, 20));

        titulo41.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        titulo41.setForeground(new java.awt.Color(51, 51, 51));
        titulo41.setText("OBSERVACIÓN:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(titulo41, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 670, 100, 20));

        lavadoVehículo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NO", "SI" }));
        lavadoVehículo.setToolTipText("");
        lavadoVehículo.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                lavadoVehículoItemStateChanged(evt);
            }
        });
        lavadoVehículo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lavadoVehículoActionPerformed(evt);
            }
        });
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(lavadoVehículo, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 710, 520, 30));

        MvtCarbon_lavadoVehículo.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        MvtCarbon_lavadoVehículo.setForeground(new java.awt.Color(102, 102, 102));
        MvtCarbon_lavadoVehículo.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(MvtCarbon_lavadoVehículo, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 280, 310, 20));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel14.setText("INFORMACIÓN DE VEHÍCULO DESCARGADO");
        ...
        jLabel58.setText("DATOS DEL REGISTRO DEL VEHÍCULO");
        ...
        jLabel105.setText("Observación:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jLabel105, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, 130, 20));

        jLabel107.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel107.setForeground(new java.awt.Color(51, 51, 51));
        jLabel107.setText("Observación:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jLabel107, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 240, 130, 20));

        jLabel108.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel108.setForeground(new java.awt.Color(51, 51, 51));
        jLabel108.setText("Lavado Vehículo:");
        InternaFrame_VisualizarMvtoCarbon.getContentPane().add(jLabel108, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, 130, 20));
        ...
        titulo.setText("LISTADO DE VEHÍCULOS REGISTRADOS");
        ...
        tabla.setComponentPopupMenu(LavadoVehiculo);
            ...
            if(fila1==-1){
                ...
                if(mvtoCarbon.getLavadoVehiculo() != null){
                    if(mvtoCarbon.getLavadoVehiculo().equals("SI")){
                        lavadoVehículo.setSelectedIndex(1);
                    }else{
                        if(mvtoCarbon.getLavadoVehiculo().equals("NO")){
                            lavadoVehículo.setSelectedIndex(0);
                        }
                    }
                }else{
                    lavadoVehículo.setSelectedIndex(0);
                }
                MvtCarbon_lavadoVehículoObservación.setText(mvtoCarbon.getLavadoVehiculo_Observacion());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(observacion_LavadoVehículo.getText().equals("")){
            JOptionPane.showMessageDialog(null, "La observación no puede etar vacia", "Advertencia",JOptionPane.INFORMATION_MESSAGE);
        }else{
            
            int retorno = 0;
            try {
                mvtoCarbon.setLavadoVehiculo(""+lavadoVehículo.getSelectedIndex());
                mvtoCarbon.setLavadoVehiculo_Observacion(observacion_LavadoVehículo.getText());
                retorno = new ControlDB_MvtoCarbon(tipoConexion).ModificarEstado_lavadoVehiculoEnMvtoCarbon( mvtoCarbon, listadoMvtoCarbon_ListadoEquipos, user);
            ...
            if(retorno==1){
                JOptionPane.showMessageDialog(null, "Se cambio el etado del lavado del vehículo de forma exitosa", "Registro Exitoso",JOptionPane.INFORMATION_MESSAGE);
                observacion_LavadoVehículo.setText("");
                paginationPanel.removeAll();
                validarSeleccionCampos();
                generarListadoMvtoCarbon();
                resizeColumnWidth(tabla);
                ...
                JOptionPane.showMessageDialog(null, "No se puedo registrar el cambio del lavado del vehículo, valide datos", "Error al registrar",JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_jButton5ActionPerformed

    private void lavadoVehículoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_lavadoVehículoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_lavadoVehículoItemStateChanged

    private void lavadoVehículoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lavadoVehículoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_lavadoVehículoActionPerformed
    ...
    private javax.swing.JPopupMenu LavadoVehiculo;
    ...
    private javax.swing.JTextArea MvtCarbon_lavadoVehículoObservación;
    ...
    private javax.swing.JComboBox<String> lavadoVehículo;
    ...
    private javax.swing.JTextArea observacion_LavadoVehículo;
