...
public final class MvtoCarbon_Procesar extends javax.swing.JPanel implements ActionListener, TableModelListener{
    ...
    public MvtoCarbon_Procesar(Usuario user, String tipoConexion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 1300, 570));
        ...
        consultar2.setBackground(new java.awt.Color(255, 255, 255));
        consultar2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        consultar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vistas/Img/procesarCcarga.png"))); // NOI18N
        consultar2.setText("PROCESAR CON CCARGA");
        consultar2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                consultar2ActionPerformed(evt);
            }
        });
        add(consultar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 125, 240, 30));
        ...
        add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 1010, 20));
                                ...
                                if(i==-1){
                                    ...
                                    switch(encabezadoTabla.get(j)){
                                        ...
                                        case "MvtoEquipo_UsuarioQuienRegistra_Nombre":{
                                            data=""+  listado.get(i).getMvtoEquipo().getUsuarioQuieRegistra().getNombres()+" "+listado.get(i).getMvtoEquipo().getUsuarioQuieRegistra().getApellidos();
                                            break;
                                        }
                                        ...
                                        case "MvtoEquipo_UsuarioQuienAutoriza_Nombre":{
                                            data=""+  listado.get(i).getMvtoEquipo().getUsuarioAutorizaRecobro().getNombres()+" "+listado.get(i).getMvtoEquipo().getUsuarioAutorizaRecobro().getApellidos();
                                            break;
                                        }
                                        ...
                                        case "MvtoEquipo_Equipo_Descripción":{
                                            data=""+  listado.get(i).getMvtoEquipo().getAsignacionEquipo().getEquipo().getDescripcion()+" "+listado.get(i).getMvtoEquipo().getAsignacionEquipo().getEquipo().getModelo();
                                            break;
                                        }
    ...
    public void tabla_Listar(String data1, String data2) throws SQLException{
        tabla.setModel(crearModeloDeTabla());
        listado=new ControlDB_MvtoCarbon(tipoConexion).buscarMvtoCarbon(data1, data2);
        proveedorDeDatos = crearProveedorDeDatos(listado); 
        paginadorDeTabla = new PaginadorDeTabla(tabla, proveedorDeDatos, new int[]{5, 10, 20, 50, 75, 100}, 10);
        paginadorDeTabla.crearListadoDeFilasPermitidas(this.paginationPanel);
        pageJComboBox = paginadorDeTabla.getComboBoxPage();
        ...
        try{
            ...
            if(contador==2){//Se validaron las dos fechas y contienen formato correcto
                ...
                try {
                    ...
                    Logger.getLogger(MvtoCarbon_Procesar.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }catch(Exception e){
            e.printStackTrace();
