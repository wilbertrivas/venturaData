...
public class Graficar_HistoricoRecaudoLavadoVehículo extends javax.swing.JFrame {
    ...
    public Graficar_HistoricoRecaudoLavadoVehículo(String title) {
        super(title);
        initComponents(); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Graficar_HistoricoRecaudoLavadoVehículo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Graficar_HistoricoRecaudoLavadoVehículo("").setVisible(true);
            }
        });
    }
    ...
    private static JFreeChart createChart(XYDataset dataset) {
        JFreeChart chart = ChartFactory.createTimeSeriesChart("RECAUDO POR CONCEPTO DE LAVADO VEHÍCULOS", "EMPRESA-EXTERNO", "VALOR EN PESOS ($)", dataset,true,true,true);
    ...
    private static XYDataset createDataset(String script, String typeConnection) {
        ...
        try {
           listado= new ControlDB_PanelControl(typeConnection).HistoricoRecaudoLavado(script);
