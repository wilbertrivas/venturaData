...
public class TimeSeriesChartDemo1 extends ApplicationFrame {
    ...
    private static XYDataset createDataset() {
        ...
        TimeSeries s4 = new TimeSeries("safdsf");
        s4.add(new Month(22, 2001), 129.6);
      
        s4.add(new Month(11, 2001), 106.1);
        s4.add(new Month(12, 2002), 111.7);
        s4.add(new Month(22, 2002), 111.0);
    ...
    public static void main(String[] args) {
        ...
        TimeSeriesChartDemo1 demo = new TimeSeriesChartDemo1(
                "Time Series ó lineas Chart Demo 1 by andres2288");
        demo.pack();
