...
public class Panel_GraficarHistoricoVehículosDescargadosVenturaDataVSControlCargaGP_Backup extends javax.swing.JPanel {
    ...
    public Panel_GraficarHistoricoVehículosDescargadosVenturaDataVSControlCargaGP_Backup(String tipoConexion, CentroOperacion centroOperacion) {
        initComponents();
                ...
                if(validar){
                    if(rangoTiempo.getSelectedIndex()==1){
                        try{
                            ...
                            try{   
                                ...
                                fechaFin=anoF+"-"+mesF+"-"+diaF+" "+"23"+":"+"59"+":00.0";
                                 ...
                                 scriptControlCargaGP += " AND [ti_fcha] BETWEEN '"+ fechaInicio+"' AND '"+ fechaFin+"'";
                            }catch(Exception e){
                        ...
                        try {
                            ...
                            this.stop();
                            Logger.getLogger(Panel_GraficarHistoricoVehículosDescargadosVenturaDataVSControlCargaGP_Backup.class.getName()).log(Level.SEVERE, null, ex);
                        } 
                    }
                }
