...
public class Graficar_HistoricoVehiculosDescargadosPorAuxilar extends javax.swing.JFrame {
    ...
    public Graficar_HistoricoVehiculosDescargadosPorAuxilar(String title) {
        super(title);
        initComponents(); 
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Graficar_HistoricoVehiculosDescargadosPorAuxilar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Graficar_HistoricoVehiculosDescargadosPorAuxilar("").setVisible(true);
            }
        });
    }
    ...
    private static JFreeChart createChart(XYDataset dataset) {
        JFreeChart chart = ChartFactory.createTimeSeriesChart("VEHÍCULOS DESCARGADOS POR AUXILIAR EN PATIO", "AUXILIAR", "VEHÍCULOS", dataset,true,true,true);
    ...
    private static XYDataset createDataset(String script, String typeConnection) {
        ...
        try {
           listado= new ControlDB_PanelControl(typeConnection).HistoricoVehiculosDescargadosPorAuxiliar(script);
        } catch (SQLException ex) {
            Logger.getLogger(Graficar_HistoricoVehiculosDescargadosPorAuxilar.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(listado != null){
            String cliente="";
