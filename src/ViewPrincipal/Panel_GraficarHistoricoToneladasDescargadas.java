...
public class Panel_GraficarHistoricoToneladasDescargadas extends javax.swing.JPanel {
    ...
    public Panel_GraficarHistoricoToneladasDescargadas(String tipoConexion, CentroOperacion centroOperacion) {
        initComponents();
                ...
                if(validar){
                    if(rangoTiempo.getSelectedIndex()==1){
                        ...
                        try {
                            ...
                            this.stop();
                            Logger.getLogger(Panel_GraficarHistoricoToneladasDescargadas.class.getName()).log(Level.SEVERE, null, ex);
                        } 
                    }
                }
                if(validar) {   
                                ...
                                if(validar){
                                    if(checkFijo.isSelected()){
                                        ...
                                        if(listado != null){
                                            ...
                                            JFreeChart chart=ChartFactory.createTimeSeriesChart("TONELADAS DESCARGADAS POR CLIENTES", "CLIENTES", "TONELADAS", dataset,true,true,true);
                                    ...
                                    if(checkFlotante.isSelected()){
                                        demo3= new Graficar_HistoricoToneladasDescargadas("");
                                        demo3.inicar("VEHÍCULOS DESCARGADOS POR CLIENTES",script,tipoConexion,Integer.parseInt(time.getSelectedItem().toString()),modalidadHilo.getSelectedItem().toString());
                                        demo3.setVisible(true);
                                        demo3.Iniciar12.start();
                                        this.stop();
                                    }
                                }
                            }
