...
public class Panel_GraficarHistoricoVehículosDescargadosPorAuxiliar extends javax.swing.JPanel {
    ...
    public Panel_GraficarHistoricoVehículosDescargadosPorAuxiliar(String tipoConexion, CentroOperacion centroOperacion) {
        initComponents();
                ...
                if(validar){
                    if(rangoTiempo.getSelectedIndex()==1){
                        ...
                        try {
                            ...
                            this.stop();
                            Logger.getLogger(Panel_GraficarHistoricoVehículosDescargadosPorAuxiliar.class.getName()).log(Level.SEVERE, null, ex);
                        } 
                    }
                }
                if(validar) {   
                                ...
                                if(validar){
                                    if(checkFijo.isSelected()){
                                        ...
                                        if(listado != null){
                                            ...
                                            JFreeChart chart=ChartFactory.createTimeSeriesChart("VEHÍCULOS DESCARGADOS POR AUXILIAR EN PATIOS", "AUXILIAR", "VEHÍCULOS", dataset,true,true,true);
                                    ...
                                    if(checkFlotante.isSelected()){
                                        demo4= new Graficar_HistoricoVehiculosDescargadosPorAuxilar("");
                                        demo4.inicar("VEHÍCULOS DESCARGADOS POR AUXILIAR EN PATIOS",script,tipoConexion,Integer.parseInt(time.getSelectedItem().toString()),modalidadHilo.getSelectedItem().toString());
