...
public class Panel_GraficarHistoricoRecuadoPorLavado extends javax.swing.JPanel {
    ...
    Graficar_HistoricoRecaudoLavadoVehículo demo4;
    ChartPanel frame;
    CentroOperacion centroOperacion;
    public Panel_GraficarHistoricoRecuadoPorLavado(String tipoConexion, CentroOperacion centroOperacion, boolean cargarInicial) {
            ...
            if(cargarInicial){
                ...
                /*//Esperamos 10  segundo para parar el hilo
                Thread.sleep(5000);
                //Codigo button parar
                Iniciar1.stop();
                Iniciar1 = new Iniciar_Graficar(tipoConexion);
                ...
                if(validar){
                    if(rangoTiempo.getSelectedIndex()==1){
                        ...
                        try {
                            ...
                            this.stop();
                            Logger.getLogger(Panel_GraficarHistoricoRecuadoPorLavado.class.getName()).log(Level.SEVERE, null, ex);
                        } 
                    }
                }
                if(validar) {   
                                ...
                                if(validar){
                                    if(checkFijo.isSelected()){
                                        ...
                                        if(listado != null){
                                            ...
                                            //JOptionPane.showMessageDialog(null, "Consulta nula");         
                                            panel.setViewportView(new Graficar_Vacia());
                                        }   
                                    }
                                    if(checkFlotante.isSelected()){
                                        demo4= new Graficar_HistoricoRecaudoLavadoVehículo("");
                                        demo4.inicar("RECAUDO POR CONCEPTO DE LAVADO VEHÍCULOS",script,tipoConexion,Integer.parseInt(time.getSelectedItem().toString()),modalidadHilo.getSelectedItem().toString());
                                        demo4.setVisible(true);
                                        demo4.Iniciar12.start();
                                        this.stop();
                                    }
                                }
                            }
